...
impl ProjectStatuses {
    pub fn into_active(self) -> ActiveProjectStatuses {
...
pub struct ActiveProjectStatuses {
    pub title: Optional<String>,
    pub id: Optional<i32>,
}

impl ActiveProjectStatuses {
    pub fn into_project_statuses(self) -> Option<ProjectStatuses> {
        Some(ProjectStatuses {
...
pub trait OrmProjectStatuses<DB: OrmDB> {
    fn project_statuses<'e>(&'e self) -> DBSelector<'e, DB, Pool<DB>, ActiveProjectStatuses>
    where 
        &'e Pool<DB>: Executor<'e, Database = DB>;
}

pub trait OrmTXProjectStatuses<'c, DB: OrmDB> {
    fn project_statuses(&'c mut self) -> TxSelector<'c, DB, ActiveProjectStatuses>;
}

impl TableSelector for ActiveProjectStatuses {
    const TABLE_NAME: &'static str = "project_statuses";
...
impl OrmProjectStatuses<sqlx::Postgres> for Orm<Pool<sqlx::Postgres>>
{
    fn project_statuses<'e>(&'e self) -> DBSelector<'e, sqlx::Postgres, Pool<sqlx::Postgres>, ActiveProjectStatuses>
    where 
...
#[cfg(feature="postgres")]
impl<'c> OrmTXProjectStatuses<'c, sqlx::Postgres> for OrmTX<sqlx::Postgres>
{
    fn project_statuses(&'c mut self) -> TxSelector<'c, sqlx::Postgres, ActiveProjectStatuses>
    {
...
#[cfg(feature="postgres")]
impl ModelOps<sqlx::Postgres> for ActiveProjectStatuses 
{
    type NonActive = ProjectStatuses;
...
#[cfg(feature="mysql")]
impl OrmProjectStatuses<sqlx::MySql> for Orm<Pool<sqlx::MySql>>
{
    fn project_statuses<'e>(&'e self) -> DBSelector<'e, sqlx::MySql, Pool<sqlx::MySql>, ActiveProjectStatuses>
    where 
...
#[cfg(feature="mysql")]
impl<'c> OrmTXProjectStatuses<'c, sqlx::MySql> for OrmTX<sqlx::MySql>
{
    fn project_statuses(&'c mut self) -> TxSelector<'c, sqlx::MySql, ActiveProjectStatuses>
    {
        TxSelector::new(self.get_inner())
    }
}
...
#[cfg(feature="mysql")]
impl ModelOps<sqlx::MySql> for ActiveProjectStatuses 
{
    type NonActive = ProjectStatuses;
    async fn save<'e,E>(self, exec: E, mode: SaveMode) -> Result<Option<Self::NonActive>, anyhow::Error> 
...
#[cfg(feature="sqlite")]
impl OrmProjectStatuses<sqlx::Sqlite> for Orm<Pool<sqlx::Sqlite>>
{
    fn project_statuses<'e>(&'e self) -> DBSelector<'e, sqlx::Sqlite, Pool<sqlx::Sqlite>, ActiveProjectStatuses>
    where 
...
#[cfg(feature="sqlite")]
impl<'c> OrmTXProjectStatuses<'c, sqlx::Sqlite> for OrmTX<sqlx::Sqlite>
{
    fn project_statuses(&'c mut self) -> TxSelector<'c, sqlx::Sqlite, ActiveProjectStatuses>
    {
        TxSelector::new(self.get_inner())
    }
}
...
#[cfg(feature="sqlite")]
impl ModelOps<sqlx::Sqlite> for ActiveProjectStatuses 
{
    type NonActive = ProjectStatuses;
    async fn save<'e,E>(self, exec: E, mode: SaveMode) -> Result<Option<Self::NonActive>, anyhow::Error> 
