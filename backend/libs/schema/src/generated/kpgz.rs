...
pub trait OrmKpgz<DB: OrmDB> {
    fn kpgz<'e>(&'e self) -> DBSelector<'e, DB, Pool<DB>, ActiveKpgz>
    where 
        &'e Pool<DB>: Executor<'e, Database = DB>;
}

pub trait OrmTXKpgz<'c, DB: OrmDB> {
    fn kpgz(&'c mut self) -> TxSelector<'c, DB, ActiveKpgz>;
}

impl TableSelector for ActiveKpgz {
    const TABLE_NAME: &'static str = "kpgz";
...
impl OrmKpgz<sqlx::Postgres> for Orm<Pool<sqlx::Postgres>>
{
    fn kpgz<'e>(&'e self) -> DBSelector<'e, sqlx::Postgres, Pool<sqlx::Postgres>, ActiveKpgz>
    where 
...
#[cfg(feature="postgres")]
impl<'c> OrmTXKpgz<'c, sqlx::Postgres> for OrmTX<sqlx::Postgres>
{
    fn kpgz(&'c mut self) -> TxSelector<'c, sqlx::Postgres, ActiveKpgz>
    {
...
#[cfg(feature="postgres")]
impl ModelOps<sqlx::Postgres> for ActiveKpgz 
{
    type NonActive = Kpgz;
...
#[cfg(feature="mysql")]
impl OrmKpgz<sqlx::MySql> for Orm<Pool<sqlx::MySql>>
{
    fn kpgz<'e>(&'e self) -> DBSelector<'e, sqlx::MySql, Pool<sqlx::MySql>, ActiveKpgz>
    where 
...
#[cfg(feature="mysql")]
impl<'c> OrmTXKpgz<'c, sqlx::MySql> for OrmTX<sqlx::MySql>
{
    fn kpgz(&'c mut self) -> TxSelector<'c, sqlx::MySql, ActiveKpgz>
    {
        TxSelector::new(self.get_inner())
    }
}
...
#[cfg(feature="mysql")]
impl ModelOps<sqlx::MySql> for ActiveKpgz 
{
    type NonActive = Kpgz;
    async fn save<'e,E>(self, exec: E, mode: SaveMode) -> Result<Option<Self::NonActive>, anyhow::Error> 
...
#[cfg(feature="sqlite")]
impl OrmKpgz<sqlx::Sqlite> for Orm<Pool<sqlx::Sqlite>>
{
    fn kpgz<'e>(&'e self) -> DBSelector<'e, sqlx::Sqlite, Pool<sqlx::Sqlite>, ActiveKpgz>
    where 
...
#[cfg(feature="sqlite")]
impl<'c> OrmTXKpgz<'c, sqlx::Sqlite> for OrmTX<sqlx::Sqlite>
{
    fn kpgz(&'c mut self) -> TxSelector<'c, sqlx::Sqlite, ActiveKpgz>
    {
        TxSelector::new(self.get_inner())
    }
}
...
#[cfg(feature="sqlite")]
impl ModelOps<sqlx::Sqlite> for ActiveKpgz 
{
    type NonActive = Kpgz;
    async fn save<'e,E>(self, exec: E, mode: SaveMode) -> Result<Option<Self::NonActive>, anyhow::Error> 
