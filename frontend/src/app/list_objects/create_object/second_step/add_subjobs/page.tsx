...
export default function AddSubjobs() {
    ...
    useEffect(() => {
        if (inputRef.current) {
            ...
            try {
                ...
                // некоторые input/textarea возможны несоответствия — безопасно игнорируем
            }
        }
    }, [editingCell]);
    ...
    const handleSave = () => {
        console.log("Сохранить данные:", tableData);
                ...
                <div className="w-full flex flex-col gap-4">
                    <div className="flex flex-row justify-between gap-14">
                        <div className="w-full flex flex-col">
                            ...
                            <select className="w-full h-[36px] border rounded-md p-2 text-sm focus:outline-none focus:ring-2 focus:ring-red-500">
                                        ...
                                        >
                                            ...
                                            {editing && editingCell?.col === "title" && (
                                                <textarea
                                                    ...
                                                    onBlur={() => stopEdit()}
                                                    onKeyDown={(e) => handleKeyDown(e, itemIdx, "title")}
                                        ...
                                        >
                                            ...
                                            {editing && editingCell?.col === "volume" && (
                                                <input
                                                    ...
                                                    onBlur={() => stopEdit()}
                                                    onKeyDown={(e) => handleKeyDown(e, itemIdx, "volume")}
                                        ...
                                        >
                                            ...
                                            {editing && editingCell?.col === "unitOfMeasurement" && (
                                                <input
                                                    ...
                                                    onBlur={() => stopEdit()}
                                                    onKeyDown={(e) => handleKeyDown(e, itemIdx, "unitOfMeasurement")}
                                                    className="w-full h-10 p-2 outline-none border rounded"
                                                />
                                            )}
                                        </td>
                                        ...
                                        >
                                            ...
                                            {editing && editingCell?.col === "startDate" && (
                                                <input
                                                    ...
                                                    onBlur={() => stopEdit()}
                                                    onKeyDown={(e) => handleKeyDown(e, itemIdx, "startDate")}
                                                    className="w-full h-10 p-2 outline-none border rounded"
                                        ...
                                        >
                                            ...
                                            {editing && editingCell?.col === "endDate" && (
                                                <input
                                                    ...
                                                    onBlur={() => stopEdit()}
                                                    onKeyDown={(e) => handleKeyDown(e, itemIdx, "endDate")}
                                                    className="w-full h-10 p-2 outline-none border rounded"
                                                    placeholder="dd.mm.yyyy"
                                                />
                                            )}
