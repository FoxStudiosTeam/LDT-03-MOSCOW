...
class MaterialCard extends StatelessWidget {
      ...
      builder: (ctx) => Column(
        ...
        children: [
          ...
          ListTile(
            ...
            onTap: () {
              Navigator.pop(ctx);
              _handleDownloadQualityPassport();
            },
          ),
          const Divider(height: 1),
          ListTile(
  ...
  void _handleDownloadTTN() {
    // Обработка скачивания ТТН
    print("Скачать ТТН для: ${data.material.title}");
    // TODO: Реализовать логику скачивания ТТН
  }

  void _handleDownloadQualityPassport() {
    // Обработка скачивания паспорта качества
    print("Скачать паспорт качества для: ${data.material.title}");
